DROP DATABASE IF EXISTS `d8bsag`;
CREATE DATABASE  IF NOT EXISTS `d8bsag` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `d8bsag`;
-- MySQL dump 10.13  Distrib 8.0.19, for Linux (x86_64)
--
-- Host: 127.0.0.1    Database: d8bsag
-- ------------------------------------------------------
...
CREATE TABLE `queue` (
  ...
  KEY `expire` (`expire`)
) ENGINE=InnoDB AUTO_INCREMENT=45 DEFAULT CHARSET=utf8mb4 COMMENT='Stores items in queues.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=71 DEFAULT CHARSET=utf8mb4 COMMENT='Table that contains logs of all system events.';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping events for database 'd8bsag'
--

--
-- Dumping routines for database 'd8bsag'
--
...
-- Dump completed on 2020-04-28 13:11:36
